...
resource Deployment_asp_appServiceplanInfo_Name 'Microsoft.Web/serverfarms@2021-01-01' = [for (item,index) in appServiceplanInfo: if (item.deploy == 1 && ASPlanInfo[index].match) {
