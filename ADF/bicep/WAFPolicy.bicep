...
resource WAFPolicy 'Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies@2020-04-01' = [for (policy, index) in WAFPolicyInfo: if (POLICY[index].match) {
  name: '${DeploymentURI}Policywaf${policy.name}'
