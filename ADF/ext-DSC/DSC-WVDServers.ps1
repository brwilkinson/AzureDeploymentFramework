...
Get-ChildItem -Path .\WVDServers -Filter *.mof -ea 0 | Remove-Item
...
Set-DscLocalConfigurationManager -Path .\WVDServers -Force 

# Push the configuration
Start-DscConfiguration -Path .\WVDServers -Wait -Verbose -Force
