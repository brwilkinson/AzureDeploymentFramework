...
Write-Verbose "ArtifactStagingDirectory is [$ADF] and App is [$App] and Enviro is [$Enviro]" -verbose
...
AzDeploy -App $App -Prefix AZC1 -DP $Enviro -TF ADF:\templates-deploy\0-azuredeploy-sub-InitialRG.json -SubscriptionDeploy #-FullUpload -VSTS
